...
const QualityTermsPage: React.FC = () => {
    ...
    // Setup SpeechRecognition (sin cambios)
    useEffect(() => {
                ...
                {currentTerm && (
                    <Card className="mb-6">
                        ...
                        <Button 
                            ...
                            className="mt-4"
                        >
                            {isLoadingGemini ? 'Enviando Explicación...' : 'Enviar y Obtener Feedback'}
                        </Button>
                    </Card>
                )}
